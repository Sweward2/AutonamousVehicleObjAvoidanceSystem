...
# states
states = ['forward', 'turn_right', 'turn_left','Rturn_right', 'Rturn_left']
...
# Check sensor values and update state
...
while robot.step(timestep) != -1:
    ...
    if current_state == 'forward':
        ...
        if (psValues[6] or psValues[7] or psValues[2] or psValues[3]) > 76.0:
            current_state = 'Rturn_right'
            counter = 0
        if (psValues[0] or psValues[1] or psValues[4] or psValues[5]) > 76.0:
            current_state = 'Rturn_left'
            counter = 0
        ...
        # check if it is necessary to update current_state
            ...
            counter = 0
         # Check if it is necessary to update current_state
        elif (psValues[2] or psValues[3] or psValues[6] or psValues[7]) > 76.0:
            current_state = 'turn_right'
            counter = 0
        elif (psValues[0] or psValues[1] or psValues[4] or psValues[5]) > 76.0:
            current_state = 'turn_left'
            counter = 0
                     # Check if it is necessary to update current_state
